var ruo_single = function (config) {
    var that = this;
    ...
    this.night = function () {
        if (body.classList.contains("neon")) {
            ...
            document.getElementById('read-open').innerHTML = "关灯";
            document.cookie = "night=false;" + "path=/;" + "max-age=21600";
        } else {
            body.classList.add("neon");
            document.getElementById('read-open').innerHTML = "开灯";
...
if (window.console && window.console.log) {
    console.log("%c Single %c http://ruo.me ", "color: #fff; margin: 1em 0; padding: 5px 0; background: #ffa628;", "margin: 1em 0; padding: 5px 0; background: #efefef;");
}
